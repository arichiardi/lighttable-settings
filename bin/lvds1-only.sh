...
XRANDR_COMMAND="xrandr --output $HDMI_NAME --off --output $LVDS_NAME --primary --mode 1366x768 --pos 0x0 --rotate normal --output VIRTUAL1 --off --output DP1 --off --output VGA1 --off"
